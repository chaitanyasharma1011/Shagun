...
export default function TopRecieved({ results }) {
  let pastSmallScreen = useMediaQuery("(min-width:768px)");
  let sortedResult = Object.values(results).sort((a, b) => {
    const amountA = a.recieved; // ignore upper and lowercase
    const amountB = b.recieved; // ignore upper and lowercase
  ...
  return (
    <div className="space-y-4 p-4 border border-[#eaeaea] rounded-lg">
      <h4 className="font-medium">Top Contributions for you</h4>
